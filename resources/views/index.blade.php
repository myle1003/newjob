            ...
            <div class="card shadow">
                ...
                @foreach ($members as $member)
                    <tr>
                        ...
                        <td>
                            <a href="#" id="' . $member->id . '" class="text-success mx-1 editIcon" data-bs-toggle="modal" data-bs-target="#editMemberModal"><i class="bi-pencil-square h4">E</i></a>
                            <a href="#" id="' . $member->id . '" class="text-danger mx-1 deleteIcon"><i class="bi-trash h4">D</i></a>
                        </td>
